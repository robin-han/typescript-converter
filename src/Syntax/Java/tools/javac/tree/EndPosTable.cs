...
namespace com.sun.tools.javac.tree
{
    ...
    /// or deletion without notice.</b></para>
    /// </summary>
    public interface EndPosTable
    {
        ...
        /// Positions.NOPOS will be returned. </summary>
        /// <param name="tree"> JCTree </param>
        /// <returns> position of the source tree or Positions.NOPOS for non-existent mapping </returns>
        int getEndPos(JCTree tree);

        /// <summary>
        /// Store ending position for a tree, the value of which is the greater of
        /// last error position and the given ending position. </summary>
        /// <param name="tree"> The tree. </param>
        /// <param name="endpos"> The ending position to associate with the tree. </param>
        ...
        /// tree. </summary>
        /// <param name="oldtree"> a JCTree to be replaced </param>
        /// <param name="newtree"> a JCTree to be replaced with </param>
        /// <returns> position of the old tree or Positions.NOPOS for non-existent mapping </returns>
