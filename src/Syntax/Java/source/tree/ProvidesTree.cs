...
namespace com.sun.source.tree
{
    ...
    /// @since 9
    /// </summary>
    public interface ProvidesTree : DirectiveTree
    {
        /// <summary>
        /// Returns the name of the service type being provided. </summary>
        /// <returns> the name of the service type being provided </returns>
        ExpressionTree getServiceName();

        /// <summary>
        /// Returns the names of the implementation types being provided. </summary>
...
//ORIGINAL LINE: java.util.List<? extends ExpressionTree> getImplementationNames();
        IList<ExpressionTree> getImplementationNames();
    }
