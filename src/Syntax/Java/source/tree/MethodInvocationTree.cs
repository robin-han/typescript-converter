...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface MethodInvocationTree : ExpressionTree
    {
        /// <summary>
        /// Returns the type arguments for this method invocation. </summary>
        ...
        /// <summary>
        /// Returns the expression identifying the method to be invoked. </summary>
        /// <returns> the method selection expression </returns>
        ExpressionTree getMethodSelect();

        /// <summary>
        /// Returns the arguments for the method invocation. </summary>
