...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface ImportTree : Tree
    {
        /// <summary>
        /// Returns true if this is a static import declaration. </summary>
        /// <returns> true if this is a static import </returns>
        bool isStatic();
        ...
        /// qualified identifier will end in "*". </summary>
        /// <returns> a qualified identifier, ending in "*" if and only if
        /// this is an import-on-demand </returns>
