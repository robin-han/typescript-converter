...
namespace com.sun.source.tree
{
    ...
    /// @since 9
    /// </summary>
    public interface PackageTree : Tree
    {
        /// <summary>
        /// Returns the annotations associated with this package declaration. </summary>
...
//ORIGINAL LINE: java.util.List<? extends AnnotationTree> getAnnotations();
        ...
        /// <summary>
        /// Returns the name of the package being declared. </summary>
