...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface CatchTree : Tree
    {
        /// <summary>
        /// Returns the catch variable.
        /// A multi-catch variable will have a
        /// <seealso cref="UnionTypeTree UnionTypeTree"/>
        /// as the type of the variable. </summary>
        /// <returns> the catch variable </returns>
        VariableTree getParameter();

        /// <summary>
        /// Returns the catch block. </summary>
