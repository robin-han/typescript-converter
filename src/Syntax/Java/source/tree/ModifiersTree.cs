...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface ModifiersTree : Tree
    {
        /// <summary>
        /// Returns the flags in this modifiers tree. </summary>
        /// <returns> the flags </returns>
        ISet<Modifier> getFlags();

        /// <summary>
        /// Returns the annotations in this modifiers tree. </summary>
