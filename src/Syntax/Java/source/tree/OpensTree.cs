...
namespace com.sun.source.tree
{
    ...
    /// @since 9
    /// </summary>
    public interface OpensTree : DirectiveTree
    {

        /// <summary>
        /// Returns the name of the package to be opened. </summary>
        /// <returns>  the name of the package to be opened </returns>
        ...
        /// </summary>
        /// <returns> the names of the modules to which the package is opened, or null </returns>
