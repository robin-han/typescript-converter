...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface TryTree : StatementTree
    {
        /// <summary>
        /// Returns the block of the {@code try} statement. </summary>
...
//ORIGINAL LINE: java.util.List<? extends CatchTree> getCatches();
        IList<CatchTree> getCatches();

        /// <summary>
        /// Returns the finally block provided in the {@code try} statement,
        /// or {@code null} if there is none. </summary>
        /// <returns> the finally block </returns>
        ...
        /// The result will be an empty list if there are no
        /// resource declarations. </summary>
        /// <returns> the resource declarations </returns>
//JAVA TO C# CONVERTER CRACKED BY X-CRACKER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.List<? extends Tree> getResources();
        IList<Tree> getResources();
    }
