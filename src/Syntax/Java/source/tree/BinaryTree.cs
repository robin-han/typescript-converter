...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface BinaryTree : ExpressionTree
    {
        /// <summary>
        /// Returns the left (first) operand of the expression. </summary>
        /// <returns> the left operand </returns>
        ExpressionTree getLeftOperand();

        /// <summary>
        /// Returns the right (second) operand of the expression. </summary>
