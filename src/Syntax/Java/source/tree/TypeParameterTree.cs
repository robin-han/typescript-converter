...
namespace com.sun.source.tree
{
    ...
    /// @since 1.6
    /// </summary>
    public interface TypeParameterTree : Tree
    {
        /// <summary>
        /// Returns the name of the type parameter. </summary>
        /// <returns> the name </returns>
       Name getName();

        /// <summary>
        /// Returns the bounds of the type parameter. </summary>
        /// <returns> the bounds </returns>
//JAVA TO C# CONVERTER CRACKED BY X-CRACKER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.List<? extends Tree> getBounds();
        IList<Tree> getBounds();

        /// <summary>
        /// Returns annotations on the type parameter declaration.
        /// 
        /// Annotations need Target meta-annotations of
        /// <seealso cref="java.lang.annotation.ElementType#TYPE_PARAMETER"/> or
        /// <seealso cref="java.lang.annotation.ElementType#TYPE_USE"/>
