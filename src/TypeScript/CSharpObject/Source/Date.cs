...
namespace GrapeCity.DataVisualization.TypeScript
{
    public class Date : Object
    {
        ...
        {
            this._value = this._dt = BASE_UTC_DATETIME.AddMilliseconds(n).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.AddDays(date - this.getDate());
        }
        ...
        {
            this._value = this._dt = this._dt.AddYears((int)(year - this.getFullYear()));
        }
        ...
        {
            this._value = this._dt = this._dt.AddHours(hour - this.getHours());
        }
        ...
        {
            this._value = this._dt = this._dt.AddMilliseconds(ms - this.getMilliseconds());
        }
        ...
        {
            this._value = this._dt = this._dt.AddMinutes(minute - this.getMinutes());
        }
        ...
        {
            this._value = this._dt = this._dt.AddMonths((int)(month - this.getMonth()));
        }
        ...
        {
            this._value = this._dt = this._dt.AddSeconds(second - this.getSeconds());
        }
        ...
        {
            this._value = this._dt = BASE_UTC_DATETIME.AddMilliseconds(tick).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddDays(date - this.getUTCDate()).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddYears((int)(year - this.getUTCFullYear())).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddHours(hour - this.getUTCHours()).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddMilliseconds(ms - this.getUTCMilliseconds()).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddMinutes(minute - this.getUTCMinutes()).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddMonths((int)(month - this.getUTCMonth())).ToLocalTime();
        }
        ...
        {
            this._value = this._dt = this._dt.ToUniversalTime().AddSeconds(second - this.getUTCSeconds()).ToLocalTime();
        }
